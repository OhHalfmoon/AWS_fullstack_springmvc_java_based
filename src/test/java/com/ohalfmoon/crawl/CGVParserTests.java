...
import com.ohalfmoon.mapper.CrawlMapper;
...
import lombok.extern.log4j.Log4j;
	...
	public class CGVParserTests {
		...
		public void testList() {
			mapper.getList().forEach(log::warn);
		}
		@Test
		public void testDownloadThumbs() throws MalformedURLException, IOException {
			...
			for(Map<String, Object> m : thumbs) {
				...
				File file = new File("C:/Users/Jonas/img", m.get("midx").toString());
				if(!file.exists()) {
					file.mkdirs();
				}
	...
	public void testDownloadStillCut() throws MalformedURLException, IOException {
		...
		for(Map<String, Object>m : list) {
			...
			File file = new File("C:/Users/Jonas/img", midx);
			if(!file.exists()) {
				file.mkdirs();
			}
