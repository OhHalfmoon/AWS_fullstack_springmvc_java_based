...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar s\idebar-dark accordion" id="accordionSidebar">
    ...
    <script src="${pageContext.request.contextPath}/resources/s/demo/chart-area-demo.js"></script>
